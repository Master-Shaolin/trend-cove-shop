...
const ProductCard = ({ product }: { product: IProductCardDetails }) => {
  return (
    <Card className="group box-border overflow-hidden flex rounded-md cursor-pointer shadow-none border-none ltr:pr-0 rtl:pl-0 pb-2 lg:pb-3 flex-col items-start transition duration-200 ease-in-out transform hover:-translate-y-1 md:hover:-translate-y-1.5 hover:shadow-product hover:border-none">
      <div className="flex w-full mb-3 md:mb-3.5">
        <img
